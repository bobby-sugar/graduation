...
const descPool = {
  ...
  nienien: [
    "线条和色块控制偏干净，突出表情辨识度，适合社媒头像和轻量展示。",
    "在保持可爱风格的同时加入了少量材质变化，增强画面层次感。",
    "本稿预留了换装和配件位置，后续可继续做系列化扩展。",
  ],
  emoji: [
  ...
  comic: [
    "分镜以阅读流畅为优先，镜头切换明确，适合移动端竖屏连续阅读。",
    "本页重点展示角色关系和情绪变化，台词量控制在易读范围内。",
    "画面节奏采用松紧交替结构，兼顾剧情推进与视觉记忆点。",
  ],
};
